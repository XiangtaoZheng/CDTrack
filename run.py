...
args.exp_file = 'yolox/exps/example/mot/yolox_s_multi_source.py'
...
for dir in tqdm.tqdm(sorted(os.listdir(input_dir))):
    ...
    if args.tracker == 'byte':
        ...
        results = bot_sort(predictor, video_path, args, exp)
    ...
    for frame in range(len(results)):
        ...
        for obj in range(num_objs):
            ...
            result = '{},{},{},{},{},{},1,{},1'.format(frame_id, track_id, bbox[0], bbox[1], bbox[2],
                                                       bbox[3], category_id)
